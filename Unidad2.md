...
Esta tipo de estructura evalúa  una condición lógica (Verdadero o Falso) para 
decidir qué bloque de código ejecutar. Permite que el programa tome decisiones 
y siga diferentes caminos. Los tipos  de Estructuras  condicionales son: [1].
...
Esta estructura se encarga de evaluar el dato que ingresa después de un procedimiento 
